...
public enum FilePaths {
    ...
    COUNTDOWN_EFFECTS_PATH, SHOOT_SOUND_EFFECTS_PATH, DOWN_SOUND_EFFECTS_PATH, HIT_SOUND_EFFECTS_PATH,
    SQUARANTINE_IMAGEPATH, TRIGORATH_IMAGEPATH, EPSILON_IMAGEPATH, BULLET_IMAGEPATH, MENU_IMAGEPATH;
